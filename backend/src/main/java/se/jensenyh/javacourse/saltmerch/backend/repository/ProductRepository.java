...
public class ProductRepository
{
...

    {
        ...
        rm = (rs, rowNum) -> new Product(// <<<< todo: CREATE RowMapper HERE
                rs.getInt("id"),
                rs.getString("category"),
                rs.getString("title"),
                rs.getString("description"),
    ...
    public int deleteProduct(int id)
    {
        ...
        // <<<< todo: call jdbcTemplate method here
    }
    ...
    public int deleteVariant(int productId, String color)
    {
        ...
        var sql = "DELETE FROM variants WHERE product_id = ? AND color = ?";// <<<< todo: WRITE SQL QUERY HERE
